...
Starting with {VertX} release `3.5.1.redhat-003`, Agroal replaced C3P0 as the default JDBC connection pool.
C3P0 and Agroal use different property names and upgrading to a newer release of {VertX} might break the JDBC connection pool configuration of your {VertX} applications.
